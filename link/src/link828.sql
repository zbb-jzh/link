...
-- ----------------------------
INSERT INTO `base_setting` VALUES ('1', '0.05', '0.10', '1000', '500', null);
...
CREATE TABLE `consumer_salary` (
  `id` varchar(50) NOT NULL DEFAULT '',
  `layerAward` double DEFAULT NULL COMMENT '层奖',
  `a_advertisingAward` double DEFAULT NULL COMMENT 'a区广告奖',
  `b_advertisingAward` double DEFAULT NULL COMMENT 'b区广告奖',
  `managementFee` double DEFAULT NULL COMMENT '管理费',
  `withdrawalFee` double DEFAULT NULL COMMENT '提现手续费',
  `realWage` double DEFAULT NULL COMMENT '实发工资',
